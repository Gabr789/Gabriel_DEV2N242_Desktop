...
from .BancoTxt import SimuladorBancoTxt



class TelaLogin:
    def __init__(self):
        self.banco =  SimuladorBancoTxt()
        self.janela = Tk()
    ...
    def validar_login(self):
        ...
        if not usuario and not senha:
            self.erro_login("Preencha os campos de usuário e senha!")
            return
        elif not usuario:
            self.erro_login("Preencha o usuário!")
            return
        elif not senha:
